...
REM
REM Generated by Vivado on Wed Nov 19 20:44:33 +0800 2025
...
echo "xvlog --incr --relax -prj top_timing_tb_vlog.prj"
call xvlog  --incr --relax -prj top_timing_tb_vlog.prj -log xvlog.log
