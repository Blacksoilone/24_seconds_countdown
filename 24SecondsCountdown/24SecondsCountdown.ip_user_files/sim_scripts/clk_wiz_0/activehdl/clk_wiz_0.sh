...
#
# Script generated by Vivado on Tue Nov 18 16:57:02 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/111work/vivado/24SecondsCountdown/24SecondsCountdown.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
